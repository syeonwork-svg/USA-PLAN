...
const DEFAULT_TIMELINE = {
  ...
  "2026-10-15": [
    ...
    { time: "17:30", title: "애틀랜타 하츠필드 잭슨 공항 도착 (현지 시간)", desc: "대한항공 KE085편 도착, 입국 심사 및 수하물 수취", locName: "Hartsfield-Jackson Atlanta International Airport", lat: 33.6407, lng: -84.4277 },
    { time: "19:00", title: "렌터카 픽업 및 숙소 이동", desc: "Hertz 렌터카에서 대형 SUV 인수 후 애틀랜타 시내 숙소 이동", locName: "Atlanta Airport Rental Car Center", lat: 33.6432, lng: -84.4492 },
    { time: "20:30", title: "저녁 식사 (Mary Mac's Tea Room)", desc: "남부 전통 가정식 늦은 식사 및 마트 장보기", locName: "Mary Mac's Tea Room", lat: 33.7725, lng: -84.3800 }
  ],
  "2026-10-16": [
  ...
  "2026-11-02": [
    ...
    { time: "12:00", title: "🛫 낮 비행기로 인천 공항 출발 (귀국)", desc: "대한항공 KE082편 이륙 (12:00 출발 -> 다음날 도착, 예약코드: EK859P)", locName: "John F. Kennedy International Airport", lat: 40.6413, lng: -73.7781 }
  ],
  "2026-11-03": [
    { time: "17:30", title: "인천국제공항 T2 도착 및 귀가", desc: "20일간의 미국 가족 여행 종료", locName: "인천국제공항 제2여객터미널", lat: 37.4602, lng: 126.4407 }
  ]
};
